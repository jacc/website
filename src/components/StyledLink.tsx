...
const styledLinkVariants = cva("transition-colors duration-150 ease-in-out", {
  variants: {
    intent: {
      primary:
...
const StyledLink: React.FC<StyledLinkProps> = ({
  ...
  onClick,
  ariaLabel,
  // Removed ...props to avoid type conflicts
}) => {
  ...
  if (isAnimated) {
    return (
      <motion.a {...anchorProps} variants={animationVariants}>
